...
const SpecificStudent = () => {
	...
	const [student, setStudent] = useState({
		links: { github: "", facebook: "", linkedIn: "", personalSite: "" },
		about: "",
		phone: "",
		name: "",
		profilePicture: "",
		...
		<div className="card-container">
			...
			<div>
				<div className="skills-class">
					...
					<Title className="title-class" level={5}>
						{student.programmingLang.join(", ")}
					</Title>
				</div>
			</div>
			...
			<div style={{ display: "flex", justifyContent: "space-between" }}>
				...
				<div className="contact-container">
					...
					<div>
						<div>
							<Title className="title-class" level={4}>
								Email: {student.email}
							</Title>
							<Title className="title-class" level={4}>
								{" "}
								Portfolio link:{" "}
								<a target="_blank" href={student.links.personalSite}>
									Click here
								</a>
							</Title>
						</div>
						<a target="_blank" href={student.links.facebook} rel="noreferrer">
							<i className="fa fa-facebook-square" aria-hidden="true"></i>
						</a>
						<a target="_blank" href={student.links.linkedIn} rel="noreferrer">
							<i className="fa fa-linkedin-square" aria-hidden="true"></i>
						</a>
						<a target="_blank" href={student.links.github} rel="noreferrer">
